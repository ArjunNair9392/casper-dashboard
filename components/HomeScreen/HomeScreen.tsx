...
const HomeScreen = () => {
    ...
    return (
        <div className={styles.homeScreenContainer}>
            ...
            <div className={styles.filesSectionLine}>
                <div className={styles.fileStatus}>
                    <div className={styles.itemStatus}>
                        <span className={styles.statusNumber}>45</span>
                        <span className={styles.statusType}>Files shared</span>
                    </div>
                    <div className={styles.itemStatus}>
                        <span className={styles.statusNumber}>24</span>
                        <span className={styles.statusType}>Files in processing</span>
                    </div>
                    <div className={styles.itemStatus}>
                        <span className={styles.statusNumber}>62</span>
                        <span className={styles.statusType}>Total Files</span>
                    </div>
                </div>
            </div>
            <div className={styles.dashboardContainer}>
                <div className={styles.projectBoxes + ' ' + styles.jsGridView}>
                    ...
                    <div className={styles.projectBoxWrapper}>
                        <div className={styles.projectBox} style={{ backgroundColor: '#fee4cb' }}>
                            {/* <div className={styles.projectBoxHeader}>Div 1</div> */}
                            <div className={styles.projectBoxContentHeader}>
                                <p className={styles.boxContentHeader}>Welcome to Casper AI</p>
                                <p className={styles.boxContentSubheader}>This is a blog post about something interesting. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                            </div>
                        </div>
                    </div>
                    {/* Video thumbnail */}
                    <div className={styles.projectBoxWrapper}>
                        ...
                        <div className={styles.projectBox} style={{ backgroundColor: "#ffd3e2" }}>
                            <iframe
                    ...
                    <div className={styles.projectBoxWrapper}>
                        <div className={styles.projectBox + ' ' + styles.socialMediaBox} style={{ backgroundColor: '#c8f7dc' }}>
                ...
                <div className={styles.projectBoxes + ' ' + styles.jsGridView + ' ' + styles.socialMediaContainer}>
                    <div className={styles.projectBoxWrapper}>
                        <div className={styles.projectBox + ' ' + styles.chatButtonContainer} style={{ backgroundColor: '#e9e7fd' }}>
                            <p><button className={styles.chatButton}>Chat with Casper</button></p>
                        </div>
                    </div>
                    <div className={styles.projectBoxWrapper + ' ' + styles.gettingStartedContainer}>
                        <div className={styles.projectBox + ' ' + styles.gettingStartedBox}>
                            <div className={styles.projectBoxHeader}>
                ...
                <div className={styles.projectBoxes + ' ' + styles.jsGridView + ' ' + styles.blogContainer}>
                    <div className={styles.projectBoxWrapper}>
                        <div className={styles.projectBox + ' ' + styles.blogBox} style={{ backgroundColor: '#d5deff' }}>
                            <div className={styles.projectBoxHeader}>
                ...
                <div className={styles.projectBoxes + ' ' + styles.jsGridView + ' ' + styles.blogContainer}>
                    <div className={styles.projectBoxWrapper}>
                        <div className={styles.projectBox + ' ' + styles.blogBox} style={{ backgroundColor: '#ffffba' }}>
                            <div className={styles.projectBoxHeader}>
